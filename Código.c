...
/* definir variavies */
int destino, origem, vertices = 15;
...
void cabecalho(void)
{
  printf("Implementacao do Algoritmo de Djstra\n");
  printf("Comandos:\n");
  printf("\t d - Adicionar Grafo\n"
  "\t r - Procura Os Menores Caminhos no Grafo\n"
  "\t CTRL+C para Sair do programa\n");
  printf("--------------------------------------------------------------------------------------------------------\n");
  printf("Valor atribuido a cada cidade");
  printf("'Capinopolis': 1, 'Centralina': 2, 'Itumbiara': 3, 'Tupaciguara': 4, 'Uberlandia': 5");
  printf("'Araguari': 6, 'Cascalho Rico': 7, 'Grupiara': 8, 'Estrela do Sul': 9, 'Romaria': 10");
  printf("'Sao_Juliana': 11, 'Indianapolis': 12, 'Douradinhos': 13, 'Monte Alegre de Minas': 14, 'Ituiutaba': 15");
  printf("--------------------------------------------------------------------------------------------------------\n");
}
